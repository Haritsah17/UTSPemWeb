<template>
  <div class="dosen-container">
    <h2 class="page-title">DATA DOSEN PENGUJI</h2>
...
export default {
  data() {
    return {
      data: JSON.parse(localStorage.getItem('dosenPengujiData')) || [],
      searchText: '',
      isAddingData: false,
      isEditing: false,
      editedIndex: null,
  ...
  methods: {
    ...
    simpanKeLocalStorage() {
      localStorage.setItem('dosenPengujiData', JSON.stringify(this.data));
    }
  }
};
</script>
